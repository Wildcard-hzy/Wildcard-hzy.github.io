...
# 🔥 News
- *2026.09*: &nbsp;🎉🎉 One paper got accepted by Elsevier Computer Communications (CC). 
...
# 💻 Experience
- *2026.02 - now* &nbsp; Research Assistant (Dingxin Scholar), College of Computer Science and Technology, Jilin University, Changchun, China.
...
# 📝 Publications 
- **Elsevier CC 2026** [Personalizing head dynamic-based maneuver prediction by incremental learning, Computer Communications (CC). Elsevier, 2026], **Zengyi Han**, Xuefu Dong, Liqiang Xu, Funing Yang, Yuuki Nishiyama, Kaoru Sezaki.
- **IEEE TMC 2025** [Federated Learning-based Distributed Data Completion in Sparse Mobile CrowdSensing, 2025 IEEE Transactions on Mobile Computing (TMC). IEEE, 2025], En Wang, Baoju Li, Wenbin Liu*, **Zengyi Han**, Cong Wang, Ximing Li, Jie Wu. DOI:10.1109/TMC.2025.3640170
...
- **IEEE ITSC 2021** [MiMoSense: An Open Crowdsensing Platform for Micro-Mobility, 2021 IEEE International Intelligent Transportation Systems Conference (ITSC). IEEE, 2021], **Zengyi Han**, Hong Duc Nguyen, Shunsuke Aoki, Yuuki Nishiyama, Kaoru Sezaki. Online Presentation.
...
<script type="text/javascript" id="mapmyvisitors" src="//mapmyvisitors.com/map.js?d=OpDXTuMh7ritl7kTODOz60bc3H5P1ehR9T6Wjqo6yCc&cl=ffffff&w=200&h=150"></script>
